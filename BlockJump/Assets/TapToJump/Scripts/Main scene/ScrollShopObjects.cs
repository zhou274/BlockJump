...
public class ScrollShopObjects : MonoBehaviour
{
    ...
    void FixedUpdate ()
    {
        ...
        else if (cubes.transform.position.x < -52.5f)
            cubes.transform.position = Vector3.MoveTowards (cubes.transform.position, new Vector3(-45f, cubes.transform.position.y, cubes.transform.position.z), Time.deltaTime * 10f);
